        ...
        <div className="auth-bg">
            ...
            <form className="auth-card" onSubmit={submit}>
                ...
                <div className="auth-actions">
                    ...
                    {canResetPassword && (
                        <Link href={route('password.request')} className="auth-link">Forgot password?</Link>
                    )}
                </div>
                <button className="auth-btn" disabled={processing}>login</button>
                <div className="auth-footer">
                    Don't have an account?{' '}
                    <Link href={route('register')} className="auth-link">Register</Link>
                </div>
            </form>
        </div>
    );
