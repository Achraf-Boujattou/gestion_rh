                ...
                <table className="min-w-full bg-white">
                    <thead>
                        <tr className="bg-gray-100">
                            <th className="px-6 py-3 text-left">Heure de début</th>
                            <th className="px-6 py-3 text-left">Heure de fin</th>
                            <th className="px-6 py-3 text-left">Motif</th>
                            <th className="px-6 py-3 text-left">Date de demande</th>
                    ...
                    <tbody>
                        {absences.map((absence) => (
                            <tr key={absence.id} className="border-b">
                                <td className="px-6 py-4">{absence.start_time}</td>
                                <td className="px-6 py-4">{absence.end_time}</td>
                                <td className="px-6 py-4">{absence.reason}</td>
                                <td className="px-6 py-4">{new Date(absence.created_at).toLocaleDateString()}</td>
